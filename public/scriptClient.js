...
function ongame() {
  ...
  document.addEventListener('mousemove', function(evt) {
    ...
    socket.emit('playerCannonMoved', { id: playerId, cannon_angle: __angle__});
  });
